...
class DataTransformation:
    ...
    def get_data_transformer_object(self)->Pipeline:
        logging.info("Entered get_data_transformation method of DataTransformation class")

        try:
            numeric_transformer = StandardScaler()
            min_max_scaler = MinMaxScaler()
            logging.info("Transformers: StandardScaler-MinMaxscaler")

            # Load schema configurations
            num_features = self._schema_config['num_features']
            mm_columns = self._schema_config['mm_features']
    ...
    def _map_gender_column(self,df):
        "Map Gender column to 0 for Females and 1 for Males"
        logging.info("Mapping Gender columns to 0 and 1")
